...
// // CLIENT_ID via variável de ambiente (GitHub Pages + Vite)
// export const CLIENT_ID = import.meta.env.VITE_SPOTIFY_CLIENT_ID;
// // Detecta ambiente DEV x PRODUÇÃO
// const isLocal = location.hostname === "localhost" || location.hostname === "127.0.0.1";

// // REDIRECT_URI dinamicamente
// export const REDIRECT_URI = isLocal
//   ? "http://127.0.0.1:5173/callback"
//   : "https://Gilardo-Bento.github.io/Spotify/callback";
...
//     code_challenge: codeChallenge,
//     state,
//     scope: "user-read-playback-state" // Perfil Viewer
//   });
...
//   accessToken = data.access_token; // manter na memória
//   sessionStorage.setItem("access_token", data.access_token); // opcional

//   // Redireciona para dashboard
//   window.location.href = `${location.origin}/Spotify/dashboard.html`;
// }
...
// // ========================================
// // API CALL DO VIEWER (música atual)
// // ========================================
// export async function getCurrentPlaying() {
//   if (!accessToken) return { playing: false };
...
//   window.location.href = `${location.origin}/Spotify/index.html`;
// }
